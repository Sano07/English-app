...
class LearnWordsTrainer {
    ...
    Word("Guitar", "Гитара"),
    Word("House", "Дом"),
    Word("Ice Cream", "Мороженое"),
    Word("Jacket", "Куртка"),
    Word("Keyboard", "Клавиатура"),
    Word("Lion", "Лев"),
    Word("Mountain", "Гора"),
    Word("Notebook", "Тетрадь"),
    ...
    Word("Sun", "Солнце"),
    Word("Tree", "Дерево"),
    Word("Umbrella", "Зонтик"),
    Word("Violin", "Скрипка"),
    Word("Water", "Вода"),
    Word("Xylophone", "Ксилофон"),
    Word("Yacht", "Яхта"),
    Word("Zebra", "Зебра"),
    Word("Book", "Книга"),
    Word("Chair", "Стул"),
    Word("Desk", "Письменный стол"),
    Word("Egg", "Яйцо"),
    Word("Fire", "Огонь"),
    Word("Glass", "Стекло"),
    Word("Hat", "Шляпа"),
    Word("Island", "Остров"),
    Word("Jellyfish", "Медуза"),
    Word("Kangaroo", "Кенгуру"),
    Word("Lighthouse", "Маяк"),
    Word("Moon", "Луна"),
    Word("Nest", "Гнездо"),
    Word("Octopus", "Осьминог"),
    ...
    Word("Flute", "Флейта"),
    Word("Giraffe", "Жираф"),
    Word("Horizon", "Горизонт"),
    Word("Icicle", "Сосулька"),
    Word("Jigsaw", "Головоломка"),
    Word("Knight", "Рыцарь"),
    Word("Lantern", "Фонарь"),
    Word("Meteor", "Метеор"),
    Word("Nebula", "Туманность"),
    Word("Opera", "Опера"),
    Word("Pyramid", "Пирамида"),
    Word("Quilt", "Стёганое одеяло"),
    Word("Ripple", "Рябь"),
    Word("Satellite", "Спутник"),
    Word("Throne", "Трон"),
    Word("Unicorn", "Единорог"),
    Word("Vortex", "Вихрь"),
    Word("Wand", "Волшебная палочка"),
    Word("Xerox", "Ксерокс"),
    Word("Yo-yo", "Йо-йо"),
    Word("Zephyr", "Зефир")
    )
